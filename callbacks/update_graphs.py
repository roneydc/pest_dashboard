...
class GraphUpdater:
    ...
    def update_all_graphs(self, year_range, fields, crops, pests):
        ...
        # Usar os novos métodos modificados para obter dados por et_code_pest
        pest_counts = self.data_processor.get_pest_distribution()  # Agora com agrupamento por código
        field_analysis = self.data_processor.get_field_analysis()  # Agora com informação de praga dominante
        crop_severity, severity_col = self.data_processor.get_crop_severity()  # Agora com detalhes por praga
        ...
        # Usar os novos métodos de visualização que esperam os dados com detalhe por código
